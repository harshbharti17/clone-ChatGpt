    ...
    <div className="flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-32 max-md:mt-14 2xl:pr-40 ">
        ...
        {messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center gap-1 text-primary ">
            <img
              ...
              className="w-full max-w-54 sm:max-w-52"
            />
            <p className="mt-2 text-4xl sm:text-5xl text-center text-gray-400 dark:text-white ">
              Ask me anything.
            </p>
          </div>
        )}
      ...
      >
        <select
          ...
          value={mode}
          className="pl-3 pr-2 outline-none cursor-pointer"
        >
